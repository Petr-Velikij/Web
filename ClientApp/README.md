...
In the WebStorm menu `Run` select `Edit Configurations...`. Then click `+` and select `JavaScript Console`. Paste `http://localhost:3000` into the URL field and save the configuration.
